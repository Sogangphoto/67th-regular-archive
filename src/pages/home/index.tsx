        ...
        >
          ...
          <div className="content space-y-4">
            ...
            >
              ...
              시간을 여운이라는 이름으로 조명합니다. 휘발되어 날아간 기억이 시간
              속에 머물다가 다시 나에게로 돌아올 수 있도록, 찰나의 소중함을
              영원으로 남길 수 있도록 셔터를 누르는 방법을 택한 이들입니다. 각기
              다른 선 위에서 환하게 빛나고 있을 점들을, 시간들을, 그 여운을
              따라가며 감상해보세요.
              <br />
              <br />
              당신에게 영원으로 남은 시간, 여운은 어떤 모습인가요? 시간이 지나간
              자리에 남겨진 사진들이 당신에게 진한 여운으로 닿기를 바랍니다.
            </div>
          </div>
          <div className="info">
            <div
